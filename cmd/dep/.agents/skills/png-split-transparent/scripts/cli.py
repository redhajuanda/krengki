...
def write_component_pngs(input_png: Path, output_dir: Path, components: list[Component]) -> list[dict[str, object]]:
    ...
    for component in components:
        ...
        subprocess.run(
            ["magick", str(input_png), "-crop", crop, "+repage", str(output_path)],
            check=True,
        )
        manifest.append(
            {
...
def main() -> int:
    ...
    manifest = write_component_pngs(input_png, output_dir, padded_components)
